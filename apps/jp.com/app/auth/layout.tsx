...
const AuthLayout = async ({ children }: { children: React.ReactNode }) => {
  return (
    <div className="to background flex overflow-hidden bg-linear-to-br from-lime-700 via-lime-50 to-lime-800">
      <div className="relative hidden flex-1 flex-col px-6 md:flex">
        <div className="w-full px-16">
          ...
          <span className="absolute right-44 bottom-44 size-40 animate-pulse rounded-full border-2 border-lime-200"></span>
