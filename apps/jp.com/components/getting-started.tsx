      ...
      {steps.map((step, index) => (
        ...
        >
          ...
          <CardHeader className="px-0">
            <span className="inline-flex size-12 items-center justify-center rounded-full border border-primary text-lg font-semibold text-primary">
              {`${index + 1}`.padStart(2, "0")}
            </span>
          </CardHeader>
          <CardContent className="space-y-3 px-0">
            <h3 className="font-heading text-2xl font-semibold uppercase">
              {step.title}
            </h3>
